...
"""
V14 AI Forex Trading Bot — Accuracy & Robustness Upgrade V6
...
class Config:
    ...
    historical_target_rows: int = 10000
...
class HistoricalDatasetBuilder:
    """Build a larger real historical dataset from a supported provider.
...
def ensure_historical_test_dataset(df: pd.DataFrame, cfg: Config, symbol: str, timeframe: str):
    ...
    if source != "TWELVE DATA":
        return x, {
            ...
            "rows": len(x),
            "expanded": False,
            "message": "Select TWELVE DATA and build real historical history; DEMO data cannot be used as statistical proof."
        }
