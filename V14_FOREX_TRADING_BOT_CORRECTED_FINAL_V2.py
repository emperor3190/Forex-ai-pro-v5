...
def init_state():
    ...
    This contains no legacy V13 daily-lock or signal-lock state.
...
def _v14_render_architecture_testing(df, cfg, symbol, timeframe):
    ...
    st.caption(
        "Tests the actual V14 decision path chronologically. These V14 Backtest and V14 Forward Test tools are the authoritative testing path; no legacy V13 testing engine is used."
    )
